...
- 2024年12月16号：提供qwen2-vl适配好的npu模型结构和执行样例
...
cd torchair/npu_tuned_model/mm/qwen2-vl
...
| 模型      | 版本                                           |
|---------|----------------------------------------------|
| qwen2-vl | [base](https://huggingface.co/Qwen/Qwen2-VL-7B-Instruct) |

# 快速体验

[qwen2-vl](./model/README.md#性能测试)
