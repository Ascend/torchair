...
class Qwen3MoeAttention(nn.Module):
    ...
    def __init__(self, config, layer_idx: Optional[int] = None):
        ...
        self.attention_dropout = config.attention_dropout
        self.atten_intermediate_size = self.head_dim * self.num_heads
        ...
        self.o_proj = nn.Linear(self.atten_intermediate_size, self.hidden_size, bias=False)
    ...
    def exec_qkv(
        ...
        **kwargs,
        ...
        query_states, key_states, value_states = qkv.split((self.num_heads * self.head_dim, \
                                                            self.num_key_value_heads * self.head_dim, \
                                                            self.num_key_value_heads * self.head_dim), dim=2)
        ...
        attn_output = attn_output.reshape(bsz, q_len, self.atten_intermediate_size)
...
class Qwen3MoeDecoderLayer(nn.Module):
    def __init__(self, config: Qwen3MoeConfig, layer_idx: int):
        ...
        self.mlp = (
            moe_class(config) if self.moe_flag else Qwen3MoeMLP(config)
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        qkv = self.attn.merged_qkv_proj(hidden_states)
...
class Qwen3MoeForCausalLMOri(Qwen3MoePreTrainedModel):
    ...
    def init_cache(
        ...
        cache_shape = (
                        batch_size,
                        cache_seq_len,
                        self.config.head_dim * max(self.config.num_key_value_heads, 1)
                      )
