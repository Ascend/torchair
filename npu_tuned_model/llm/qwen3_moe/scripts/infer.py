...
def run_qwen3_moe(model_path, execute_mode, **kwargs):
    preset_prompts = generate_prompt(1, args.tokenizer_mode)
    model_runner = Qwen3MoeRunner(model_path, execute_mode, **kwargs)
...
if __name__ == "__main__":
    ...
    run_qwen3_moe(args.model_path, args.execute_mode, **config)
