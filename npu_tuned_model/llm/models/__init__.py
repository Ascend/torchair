...
class ModelRegistry:
    ...
    def load_model_cls(model_name: str) -> Optional[Type[nn.Module]]:
        ...
        model_path, module_file, model_cls_name = _MODELS[model_name]
        module = importlib.import_module(
            f"models.{model_path}.{module_file}")
    ...
    def get_model_injection_policy(model_name: str):
        ...
        model_path, module_file, model_cls_name, layers = _MODEL_INJECTION_POLICY[model_name]
        module = importlib.import_module(
            f"models.{model_path}.{module_file}")
