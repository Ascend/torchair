...
class GenerationMixin:
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        logging.info("First token cost time: {} s".format(first_step_runtime))
        if cnt > 1:
            logging.info("Average increment token cost time: {} s".format((run_time / (cnt - 1))))
        logging.info("Total token cost time : {} s".format(first_step_runtime + run_time))
