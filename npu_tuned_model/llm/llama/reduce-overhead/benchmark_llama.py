...
# prompts的size大小决定了模型执行时的batch size大小,可根据实际想验证的场景进行修改
_PROMPTS = [
    "用一句话描述地球为什么是独一无二的。",
...
def parse_args():
    ...
    parser.add_argument('--graph_mode', type=str, default="max-autotune", choices=["max-autotune", "reduce-overhead"],
                        help="max-autotune or reduce-overhead")
...
if __name__ == "__main__":
    ...
    os.environ["GRAPH_MODE"] = args.graph_mode
