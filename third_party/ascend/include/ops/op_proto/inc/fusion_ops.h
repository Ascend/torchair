...
REG_OP(GroupedMatmulSwigluQuantV2)
      .INPUT(x, TensorType({DT_INT8, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN}))
      .INPUT(x_scale, TensorType({DT_FLOAT, DT_FLOAT8_E8M0}))
      .INPUT(group_list, TensorType{DT_INT64})
      .DYNAMIC_INPUT(weight, TensorType({DT_INT8, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN}))
      .DYNAMIC_INPUT(weight_scale, TensorType({DT_FLOAT, DT_FLOAT8_E8M0}))
      ...
      .OUTPUT(y, TensorType({DT_INT8, DT_FLOAT8_E5M2, DT_FLOAT8_E4M3FN}))
