 ...
 * @li quant_mode: Optional parameter. Type is:Int. The value is in -1(unquant), 0(static), 1(dynamic), 2(fp8_e5m2), 3(fp8_e4m3fn), 6(hif8_cast), 7(hif8_pertensor), 8(hif8_pertoken) of quant mode. Default: -1.
...
/**
* @brief Function FusedCausalConv1d (non-inplace).
*
* @par Inputs:
...
* @li cache_indices: Optional. Index mapping each sequence to its cache slot. 1D [batch] or 2D [batch, max_num_blocks]. int32.
...
* @li block_idx_first_scheduled_token: Optional. Block index of first scheduled token per batch (APC). shape [batch]. int32.
* @li block_idx_last_scheduled_token: Optional. Block index of last scheduled token per batch (APC). shape [batch]. int32.
* @li initial_state_idx: Optional. Initial state block index per batch (APC). shape [batch]. int32.
*
* @par Attributes:
* @li activation_mode: An int. Activation function type: 0 (None), 1 (silu), 2 (swish). Default 0.
* @li pad_slot_id: An int. Slot ID used to skip padding batches. Default -1.
* @li run_mode: An int. Execution mode (legacy, not supported). Default 0.
* @li max_query_len: An int. Max sequence length across all batches. Default -1.
* @li residual_connection: An int. Whether to use residual connection: 0 (no), 1 (yes). Default 1.
* @li block_size: An int. APC block size, supports 128/256. Default 128.
* @li conv_mode: An int. Convolution mode: 0 (default), 1 (Pangu v2). Default 0.
*
* @par Outputs:
...
/**
* @brief Function InplaceFusedCausalConv1d (inplace).
*
* @par Inputs:
* Same as FusedCausalConv1d.
*
* @par Attributes:
* Same as FusedCausalConv1d.
*
* @par Outputs:
* @li conv_states: Updated cache state tensor. Same shape and type as input conv_states.
* @li x: Output written back to input x. Same shape and type as input x.
*/
