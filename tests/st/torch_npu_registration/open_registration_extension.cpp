...
void for_deserialization(const at::Tensor &t, std::unordered_map<std::string, bool> &m) {
  ...
  c10::intrusive_ptr<c10::BackendMeta> new_tmeta{
      std::unique_ptr<c10::BackendMeta>(new CustomBackendMetadata(backend_version_format, format_number))};
...
c10::intrusive_ptr<c10::StorageImpl> make_custom_storage_impl(c10::StorageImpl::use_byte_size_t, c10::SymInt size_bytes,
...
at::Tensor custom_empty_memory_format(at::IntArrayRef size, c10::optional<at::ScalarType> dtype,
  ...
  return at::detail::empty_generic(size, &global_custom_alloc, private_use_ks, c10::dtype_or_default(dtype),
                                   memory_format);
}
at::Tensor custom_empty_symint(c10::IntArrayRef size, c10::optional<at::ScalarType> dtype,
                               c10::optional<at::Layout> layout, c10::optional<at::Device> device,
                               c10::optional<bool> pin_memory, c10::optional<at::MemoryFormat> memory_format) {
  constexpr c10::DispatchKeySet private_use_ks(c10::DispatchKey::PrivateUse1);
  return at::detail::empty_generic(size, &global_custom_alloc, private_use_ks, c10::dtype_or_default(dtype),
...
at::Tensor custom_empty_strided(c10::IntArrayRef size, c10::IntArrayRef stride, c10::optional<at::ScalarType> dtype_opt,
...
at::Tensor &custom_set_source_Storage(at::Tensor &result, c10::Storage src) {
  ...
  at::native::resize_impl_cpu_(result.unsafeGetTensorImpl(), new_size, stride_opt,
                               /*resize_storage=*/!result.is_meta());
  return result;
}

// Some set operations for the basic use case
at::Tensor &custom_set_source_Storage_storage_offset(at::Tensor &result, c10::Storage storage, int64_t storage_offset,
...
c10::Device get_current_device() {
  return c10::Device(c10::DeviceType::PrivateUse1, 0);
}
void register_npu() {
  C10_REGISTER_GUARD_IMPL(PrivateUse1, c10::impl::NoOpDeviceGuardImpl<c10::DeviceType::PrivateUse1>);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("register_npu", &register_npu, "register npu impl");
  m.def("current_device", &get_current_device, "get custom device object");
