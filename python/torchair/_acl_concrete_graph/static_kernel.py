...
def _install_or_compile_static_kernel(fx_func, *args, cached_cann_version=None, compile_cache_dir=None, cached_deterministic=None, super_kernel_optimize=None, **kwargs):
    if _is_single_card():
...
def _install_or_compile_for_single(fx_func, *args, cached_cann_version=None, compile_cache_dir=None, cached_deterministic=None, super_kernel_optimize=None, **kwargs):
    ...
    if run_package_status == RunPackageStatus.INSTALLED:
        ...
        _compile_static_kernel_for_single_card(fx_func, *args, is_cache_compile=True, build_dir=compile_cache_dir, super_kernel_optimize=super_kernel_optimize, **kwargs)


def _install_or_compile_for_multi(fx_func, *args, cached_cann_version=None, compile_cache_dir=None, cached_deterministic=None, super_kernel_optimize=None, **kwargs):
    # 多卡流程
    ...
    if received_run_package_status != RunPackageStatus.NEED_COMPILE:
        ...
        _compile_static_kernel_for_multi_card(fx_func, *args, gloo_group=gloo_group, is_cache_compile=True, build_dir=compile_cache_dir, super_kernel_optimize=super_kernel_optimize, **kwargs)
...
def _compile_static_kernel_for_multi_card(fx_func, *args, gloo_group=None, is_cache_compile=False, build_dir=None, super_kernel_optimize=None, **kwargs):
    rank = dist.get_rank()
    result_root = safe_resolve_output_dir(build_dir)
    warnings.warn(
