from torchair._ge_concrete_graph.ge_converter.experimental.hcom_allreduce import backup_custom_all_reduce
from torchair._ge_concrete_graph.ge_converter.experimental.hcom_allreduce import get_npu_all_reduce
