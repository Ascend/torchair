...
from torchair._ge_concrete_graph.compat_ir import is_cann_compat
...
def conveter_npu_prefetch_default(
    ...
    error_msg = is_cann_compat("Cmo", runtime_optional_inputs=(), runtime_optional_attrs=())
    is_old_version = "OperatorFactory find optype" in error_msg

    if (offset != 0) and is_old_version:
