...
@register_fx_node_ge_converter(torch.ops.npu._npu_kv_quant_sparse_flash_attention_pioneer.default)
def convert_npu_kv_quant_sparse_flash_attention_pioneer(
    query: Tensor,
    key: Tensor,
    value: Tensor,
    ...
    *,
    ...
    key_sink: Optional[Tensor] = None,
    value_sink: Optional[Tensor] = None,
    ...
    import torch_npu
    if hasattr(torch_npu, "hifloat8") and torch_npu.hifloat8 is not None:
