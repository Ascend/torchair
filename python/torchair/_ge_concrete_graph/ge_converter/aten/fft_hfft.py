...
def conveter_aten_fft_hfft_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_hfft.default ge_converter is not implemented!")
...
def conveter_aten_fft_hfft_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.fft_hfft.out ge_converter is not implemented!")
