...
def conveter_aten_fft_rfft2_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_rfft2.default ge_converter is not implemented!")
...
def conveter_aten_fft_rfft2_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.fft_rfft2.out ge_converter is not implemented!")
