...
def conveter_aten_neg_default(self: Tensor, meta_outputs: TensorSpec = None):
...
def conveter_aten_neg_int(a: int, meta_outputs: TensorSpec = None):
...
def conveter_aten_neg_float(a: float, meta_outputs: TensorSpec = None):
...
def conveter_aten_neg_complex(a: complex, meta_outputs: TensorSpec = None):
...
def conveter_aten_neg_Scalar(a: Union[Number, Tensor], meta_outputs: TensorSpec = None):
