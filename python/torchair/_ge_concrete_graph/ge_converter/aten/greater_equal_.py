...
def conveter_aten_greater_equal__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal_.Scalar ge_converter is not implemented!")
...
def conveter_aten_greater_equal__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal_.Tensor ge_converter is not implemented!")
