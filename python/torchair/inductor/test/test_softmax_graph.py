    ...
    def test_graph_codegen(self):
        ...
        expect.splice(
            f"""def {graph_name}():
                    ...
                    todtype = ascir.ops.ToDtype('todtype')
                    todtype.attr.sched.exec_order = 3
                    todtype.attr.sched.axis = [z0, z1]
                    todtype.x = load.y
                    todtype.attr.src = ascir.dtypes.float16
                    todtype.attr.dst = ascir.dtypes.float32
                    max = ascir.ops.Max('max')
                    max.attr.sched.exec_order = 4
                    max.attr.sched.axis = [z0, z1]
                    max.x = todtype.y
                    max.attr.src_dtype = ascir.dtypes.float32
                    max.attr.dst_dtype = ascir.dtypes.float32
                    max.attr.compute_type = 'reduce'
                    max.y.axis = [z0]
                    ...
                    todtype1 = ascir.ops.ToDtype('todtype1')
                    todtype1.attr.sched.exec_order = 8
                    todtype1.attr.sched.axis = [z0, z1]
                    todtype1.x = load1.y
                    todtype1.attr.src = ascir.dtypes.float16
                    todtype1.attr.dst = ascir.dtypes.float32
                    ...
                    sum.x = load3.y
                    sum.attr.src_dtype = ascir.dtypes.float32
                    sum.attr.dst_dtype = ascir.dtypes.float32
                    sum.attr.compute_type = 'reduce'
                    sum.y.axis = [z0]
                    ...
                    todtype2 = ascir.ops.ToDtype('todtype2')
                    todtype2.attr.sched.exec_order = 23
                    todtype2.attr.sched.axis = [z0, z1]
                    todtype2.x = truediv.y
                    todtype2.attr.src = ascir.dtypes.float32
                    todtype2.attr.dst = ascir.dtypes.float16
