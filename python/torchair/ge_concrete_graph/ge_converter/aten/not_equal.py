...
def conveter_aten_not_equal_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal.Tensor ge converter is not implement!")
...
def conveter_aten_not_equal_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal.Scalar ge converter is not implement!")
...
def conveter_aten_not_equal_Scalar_out(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal.Scalar_out ge converter is not implement!")
...
def conveter_aten_not_equal_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal.Tensor_out ge converter is not implement!")
