...
def conveter_aten__resize_output_default(
    ...
    raise NotImplementedError("torch.ops.aten._resize_output.default ge converter is not implement!")
...
def conveter_aten__resize_output_out(
    ...
    raise NotImplementedError("torch.ops.aten._resize_output.out ge converter is not implement!")
