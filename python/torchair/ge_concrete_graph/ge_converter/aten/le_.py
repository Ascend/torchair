...
def conveter_aten_le__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.le_.Scalar ge converter is not implement!")


@register_fx_node_ge_converter(torch.ops.aten.le_.Tensor)
def conveter_aten_le__Tensor(
        self: Tensor,
        other: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::le_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!) """
    raise NotImplementedError("torch.ops.aten.le_.Tensor ge converter is not implement!")
