...
def conveter_aten_fmax_default(
        self: Tensor,
        other: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::fmax(Tensor self, Tensor other) -> Tensor """
    raise NotImplementedError("torch.ops.aten.fmax.default ge converter is not implement!")
...
def conveter_aten_fmax_out(
    ...
    raise NotImplementedError("torch.ops.aten.fmax.out ge converter is not implement!")
