...
def conveter_aten_upsample_nearest2d_vec(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_nearest2d.vec ge converter is not implement!")
...
def conveter_aten_upsample_nearest2d_default(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_nearest2d.default ge converter is not implement!")
...
def conveter_aten_upsample_nearest2d_out(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_nearest2d.out ge converter is not implement!")
