...
def conveter_aten_ne__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.ne_.Scalar ge converter is not implement!")


@register_fx_node_ge_converter(torch.ops.aten.ne_.Tensor)
def conveter_aten_ne__Tensor(
        self: Tensor,
        other: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::ne_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!) """
    raise NotImplementedError("torch.ops.aten.ne_.Tensor ge converter is not implement!")
