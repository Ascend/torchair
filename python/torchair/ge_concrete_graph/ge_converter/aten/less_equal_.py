...
def conveter_aten_less_equal__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.less_equal_.Scalar ge converter is not implement!")
...
def conveter_aten_less_equal__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.less_equal_.Tensor ge converter is not implement!")
