...
def conveter_aten_min_other(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_min_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
