...
def conveter_aten_isnan_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_isnan_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_isnan_complex(a: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
