...
def conveter_aten_special_log_ndtr_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::special_log_ndtr(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_log_ndtr.default ge converter is not implement!")
...
def conveter_aten_special_log_ndtr_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_log_ndtr.out ge converter is not implement!")
