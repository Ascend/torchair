...
def conveter_aten_addcmul_default(
    ...
    raise NotImplementedError("torch.ops.aten.addcmul.default ge converter is not implement!")
...
def conveter_aten_addcmul_out(
    ...
    raise NotImplementedError("torch.ops.aten.addcmul.out ge converter is not implement!")
