...
def conveter_aten_rand_like_default(
    ...
    raise NotImplementedError("torch.ops.aten.rand_like.default ge converter is not implement!")
...
def conveter_aten_rand_like_out(
    ...
    raise NotImplementedError("torch.ops.aten.rand_like.out ge converter is not implement!")
