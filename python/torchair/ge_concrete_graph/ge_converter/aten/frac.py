...
def conveter_aten_frac_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::frac(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.frac.default ge converter is not implement!")
...
def conveter_aten_frac_out(
    ...
    raise NotImplementedError("torch.ops.aten.frac.out ge converter is not implement!")
