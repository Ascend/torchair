...
def conveter_aten_rad2deg_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::rad2deg(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.rad2deg.default ge converter is not implement!")
...
def conveter_aten_rad2deg_out(
    ...
    raise NotImplementedError("torch.ops.aten.rad2deg.out ge converter is not implement!")
