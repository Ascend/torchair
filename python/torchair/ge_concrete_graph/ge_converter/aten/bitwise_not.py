...
def conveter_aten_bitwise_not_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::bitwise_not(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.bitwise_not.default ge_converter is not implemented!")
