...
def conveter_aten_sinc_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::sinc(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.sinc.default ge converter is not implement!")
...
def conveter_aten_sinc_out(
    ...
    raise NotImplementedError("torch.ops.aten.sinc.out ge converter is not implement!")
