...
def conveter_aten_logit_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.logit_backward.default ge converter is not implement!")
...
def conveter_aten_logit_backward_grad_input(
    ...
    raise NotImplementedError("torch.ops.aten.logit_backward.grad_input ge converter is not implement!")
