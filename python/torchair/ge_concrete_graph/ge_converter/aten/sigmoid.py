...
def conveter_aten_sigmoid_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::sigmoid(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.sigmoid.default ge_converter is not implemented!")
