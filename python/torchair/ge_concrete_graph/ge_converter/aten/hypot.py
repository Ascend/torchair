...
def conveter_aten_hypot_default(
        self: Tensor,
        other: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::hypot(Tensor self, Tensor other) -> Tensor """
    raise NotImplementedError("torch.ops.aten.hypot.default ge converter is not implement!")
...
def conveter_aten_hypot_out(
    ...
    raise NotImplementedError("torch.ops.aten.hypot.out ge converter is not implement!")
