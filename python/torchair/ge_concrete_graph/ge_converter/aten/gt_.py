...
def conveter_aten_gt__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.gt_.Scalar ge converter is not implement!")


@register_fx_node_ge_converter(torch.ops.aten.gt_.Tensor)
def conveter_aten_gt__Tensor(
        self: Tensor,
        other: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::gt_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!) """
    raise NotImplementedError("torch.ops.aten.gt_.Tensor ge converter is not implement!")
