...
def conveter_aten_special_erfcx_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::special_erfcx(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_erfcx.default ge converter is not implement!")
...
def conveter_aten_special_erfcx_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_erfcx.out ge converter is not implement!")
