...
def conveter_aten_max_other(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_max_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
