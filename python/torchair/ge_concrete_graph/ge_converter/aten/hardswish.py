...
def conveter_aten_hardswish_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::hardswish(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.hardswish.default ge converter is not implement!")
...
def conveter_aten_hardswish_out(
    ...
    raise NotImplementedError("torch.ops.aten.hardswish.out ge converter is not implement!")
