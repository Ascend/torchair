...
def conveter_aten_hardswish_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::hardswish(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.hardswish.default ge_converter is not implemented!")
