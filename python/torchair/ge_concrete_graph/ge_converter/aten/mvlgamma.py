...
def conveter_aten_mvlgamma_default(self: Tensor, p: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mvlgamma_out(
    self: Tensor, p: int, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
