...
def conveter_aten_sgn_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::sgn(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.sgn.default ge converter is not implement!")
...
def conveter_aten_sgn_out(
    ...
    raise NotImplementedError("torch.ops.aten.sgn.out ge converter is not implement!")
