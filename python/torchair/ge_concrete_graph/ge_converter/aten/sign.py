...
def conveter_aten_sign_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::sign(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.sign.default ge converter is not implement!")
...
def conveter_aten_sign_out(
    ...
    raise NotImplementedError("torch.ops.aten.sign.out ge converter is not implement!")
