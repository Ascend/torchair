...
def conveter_aten_greater_equal_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal.Tensor ge converter is not implement!")
...
def conveter_aten_greater_equal_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal.Scalar ge converter is not implement!")
...
def conveter_aten_greater_equal_Scalar_out(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal.Scalar_out ge converter is not implement!")
...
def conveter_aten_greater_equal_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.greater_equal.Tensor_out ge converter is not implement!")
