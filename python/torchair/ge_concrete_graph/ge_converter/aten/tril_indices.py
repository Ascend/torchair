...
def conveter_aten_tril_indices_default(
    ...
    raise NotImplementedError("torch.ops.aten.tril_indices.default ge converter is not implement!")
...
def conveter_aten_tril_indices_out(
    ...
    raise NotImplementedError("torch.ops.aten.tril_indices.out ge converter is not implement!")
