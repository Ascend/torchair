...
def conveter_aten_conj_physical_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::conj_physical(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.conj_physical.default ge converter is not implement!")
...
def conveter_aten_conj_physical_out(
    ...
    raise NotImplementedError("torch.ops.aten.conj_physical.out ge converter is not implement!")
