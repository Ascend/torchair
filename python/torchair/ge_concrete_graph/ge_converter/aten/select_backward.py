...
def conveter_aten_select_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.select_backward.default ge converter is not implement!")
...
def conveter_aten_select_backward_out(
    ...
    raise NotImplementedError("torch.ops.aten.select_backward.out ge converter is not implement!")
