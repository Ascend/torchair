...
def conveter_aten_floor_divide__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.floor_divide_.Scalar ge converter is not implement!")
...
def conveter_aten_floor_divide__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.floor_divide_.Tensor ge converter is not implement!")
