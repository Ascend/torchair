...
def conveter_aten_floor_divide_default(
    ...
    raise NotImplementedError("torch.ops.aten.floor_divide.default ge converter is not implement!")
...
def conveter_aten_floor_divide_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.floor_divide.Scalar ge converter is not implement!")
...
def conveter_aten_floor_divide_out(
    ...
    raise NotImplementedError("torch.ops.aten.floor_divide.out ge converter is not implement!")
