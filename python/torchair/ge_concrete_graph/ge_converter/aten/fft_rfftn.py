...
def conveter_aten_fft_rfftn_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_rfftn.default ge converter is not implement!")
...
def conveter_aten_fft_rfftn_out(
    ...
    raise NotImplementedError("torch.ops.aten.fft_rfftn.out ge converter is not implement!")
