...
def conveter_aten_reciprocal_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::reciprocal(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.reciprocal.default ge converter is not implement!")
...
def conveter_aten_reciprocal_out(
    ...
    raise NotImplementedError("torch.ops.aten.reciprocal.out ge converter is not implement!")
