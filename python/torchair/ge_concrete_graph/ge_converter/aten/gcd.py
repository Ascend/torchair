...
def conveter_aten_gcd_default(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_gcd_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
