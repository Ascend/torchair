...
def conveter_aten_log2_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::log2(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.log2.default ge converter is not implement!")
...
def conveter_aten_log2_out(
    ...
    raise NotImplementedError("torch.ops.aten.log2.out ge converter is not implement!")
