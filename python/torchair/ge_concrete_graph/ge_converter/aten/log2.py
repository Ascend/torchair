...
def conveter_aten_log2_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::log2(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.log2.default ge_converter is not implemented!")
