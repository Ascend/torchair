...
def conveter_aten_arccos_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::arccos(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arccos.default ge converter is not implement!")
...
def conveter_aten_arccos_out(
    ...
    raise NotImplementedError("torch.ops.aten.arccos.out ge converter is not implement!")
