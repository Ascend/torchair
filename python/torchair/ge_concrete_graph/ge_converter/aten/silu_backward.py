...
def conveter_aten_silu_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.silu_backward.default ge converter is not implement!")
...
def conveter_aten_silu_backward_grad_input(
    ...
    raise NotImplementedError("torch.ops.aten.silu_backward.grad_input ge converter is not implement!")
