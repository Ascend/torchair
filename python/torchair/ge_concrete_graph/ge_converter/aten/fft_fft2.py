...
def conveter_aten_fft_fft2_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_fft2.default ge converter is not implement!")
...
def conveter_aten_fft_fft2_out(
    ...
    raise NotImplementedError("torch.ops.aten.fft_fft2.out ge converter is not implement!")
