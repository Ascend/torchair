...
def conveter_aten_exp2_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::exp2(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.exp2.default ge converter is not implement!")
...
def conveter_aten_exp2_out(
    ...
    raise NotImplementedError("torch.ops.aten.exp2.out ge converter is not implement!")
