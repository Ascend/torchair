...
def conveter_aten_bitwise_or_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_or_Scalar_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Scalar_Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_or_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Scalar ge converter is not implement!")
...
def conveter_aten_bitwise_or_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Tensor_out ge converter is not implement!")
...
def conveter_aten_bitwise_or_Scalar_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Scalar_out ge converter is not implement!")
...
def conveter_aten_bitwise_or_Scalar_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or.Scalar_Tensor_out ge converter is not implement!")
