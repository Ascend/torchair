...
def conveter_aten_le_Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::le.Tensor(Tensor self, Tensor other) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.le.Tensor ge_converter is not implemented!")
...
def conveter_aten_le_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_le_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_le_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_le_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_le_str(a: str, b: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
