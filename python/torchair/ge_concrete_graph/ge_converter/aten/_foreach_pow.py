...
def conveter_aten__foreach_pow_List(
    self: List[Tensor], exponent: List[Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten__foreach_pow_Scalar(
    self: List[Tensor], exponent: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten__foreach_pow_ScalarList(
    self: List[Tensor], exponent: Union[List[Number], Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten__foreach_pow_ScalarAndTensor(
    self: Union[Number, Tensor], exponent: List[Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
