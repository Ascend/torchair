...
def conveter_aten_index_Tensor_hacked_twin(
    self: Tensor, indices: List[Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_index_str(
    self: str, substr: str, start: int = 0, end: int = -1, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_index_list_int(self: List[int], el: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_index_list_float(
    self: List[float], el: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_index_list_bool(self: List[bool], el: bool, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_index_list_Tensor(
    self: List[Tensor], el: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_index_list_str(self: List[str], el: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
