...
def conveter_aten_meshgrid_default(tensors: List[Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_meshgrid_indexing(
    tensors: List[Tensor], *, indexing: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
