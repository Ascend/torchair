...
def conveter_aten_igamma_default(
        self: Tensor,
        other: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::igamma(Tensor self, Tensor other) -> Tensor """
    raise NotImplementedError("torch.ops.aten.igamma.default ge converter is not implement!")
...
def conveter_aten_igamma_out(
    ...
    raise NotImplementedError("torch.ops.aten.igamma.out ge converter is not implement!")
