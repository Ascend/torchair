...
def conveter_aten_bitwise_or__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or_.Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_or__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_or_.Scalar ge converter is not implement!")
