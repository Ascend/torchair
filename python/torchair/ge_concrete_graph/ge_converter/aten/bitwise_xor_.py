...
def conveter_aten_bitwise_xor__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_xor_.Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_xor__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_xor_.Scalar ge converter is not implement!")
