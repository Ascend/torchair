...
def conveter_aten_vdot_default(
        self: Tensor,
        other: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::vdot(Tensor self, Tensor other) -> Tensor """
    raise NotImplementedError("torch.ops.aten.vdot.default ge converter is not implement!")
...
def conveter_aten_vdot_out(
    ...
    raise NotImplementedError("torch.ops.aten.vdot.out ge converter is not implement!")
