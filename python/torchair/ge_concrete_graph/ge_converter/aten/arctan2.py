...
def conveter_aten_arctan2_default(
    ...
    raise NotImplementedError("torch.ops.aten.arctan2.default ge converter is not implement!")
...
def conveter_aten_arctan2_out(
    ...
    raise NotImplementedError("torch.ops.aten.arctan2.out ge converter is not implement!")
