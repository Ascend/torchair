...
def conveter_aten_replication_pad2d_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.replication_pad2d_backward.default ge converter is not implement!")
...
def conveter_aten_replication_pad2d_backward_grad_input(
    ...
    raise NotImplementedError("torch.ops.aten.replication_pad2d_backward.grad_input ge converter is not implement!")
