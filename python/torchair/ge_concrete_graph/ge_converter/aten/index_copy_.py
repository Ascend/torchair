...
def conveter_aten_index_copy__default(
    ...
    raise NotImplementedError("torch.ops.aten.index_copy_.default ge converter is not implement!")
...
def conveter_aten_index_copy__dimname(
    ...
    raise NotImplementedError("torch.ops.aten.index_copy_.dimname ge converter is not implement!")
