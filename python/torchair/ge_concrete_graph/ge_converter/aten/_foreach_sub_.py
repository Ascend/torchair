...
def conveter_aten__foreach_sub__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_sub_.Scalar ge converter is not implement!")
...
def conveter_aten__foreach_sub__List(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_sub_.List ge converter is not implement!")
...
def conveter_aten__foreach_sub__ScalarList(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_sub_.ScalarList ge converter is not implement!")
