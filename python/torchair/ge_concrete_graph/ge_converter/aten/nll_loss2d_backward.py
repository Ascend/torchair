...
def conveter_aten_nll_loss2d_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.nll_loss2d_backward.default ge converter is not implement!")
...
def conveter_aten_nll_loss2d_backward_grad_input(
    ...
    raise NotImplementedError("torch.ops.aten.nll_loss2d_backward.grad_input ge converter is not implement!")
