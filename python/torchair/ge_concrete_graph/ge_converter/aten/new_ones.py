...
def conveter_aten_new_ones_default(
    ...
    raise NotImplementedError("torch.ops.aten.new_ones.default ge converter is not implement!")
...
def conveter_aten_new_ones_out(
    ...
    raise NotImplementedError("torch.ops.aten.new_ones.out ge converter is not implement!")
