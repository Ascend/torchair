...
def conveter_aten__euclidean_dist_default(
    ...
    raise NotImplementedError("torch.ops.aten._euclidean_dist.default ge converter is not implement!")
...
def conveter_aten__euclidean_dist_out(
    ...
    raise NotImplementedError("torch.ops.aten._euclidean_dist.out ge converter is not implement!")
