...
def conveter_aten__euclidean_dist_default(
    x1: Tensor, x2: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten__euclidean_dist_out(
    x1: Tensor, x2: Tensor, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
