...
def conveter_aten_arccosh_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::arccosh(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arccosh.default ge converter is not implement!")
...
def conveter_aten_arccosh_out(
    ...
    raise NotImplementedError("torch.ops.aten.arccosh.out ge converter is not implement!")
