...
def conveter_aten_lt_Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_lt_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.lt.Scalar ge_converter is not implemented!")
...
def conveter_aten_lt_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_lt_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_lt_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_lt_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_lt_str(a: str, b: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
