...
def conveter_aten_logical_xor_default(
    ...
    raise NotImplementedError("torch.ops.aten.logical_xor.default ge converter is not implement!")
...
def conveter_aten_logical_xor_out(
    ...
    raise NotImplementedError("torch.ops.aten.logical_xor.out ge converter is not implement!")
