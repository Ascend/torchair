...
def conveter_aten_greater__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.greater_.Scalar ge converter is not implement!")
...
def conveter_aten_greater__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.greater_.Tensor ge converter is not implement!")
