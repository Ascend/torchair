...
def conveter_aten_log_sigmoid_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.log_sigmoid_backward.default ge converter is not implement!")
...
def conveter_aten_log_sigmoid_backward_grad_input(
    ...
    raise NotImplementedError("torch.ops.aten.log_sigmoid_backward.grad_input ge converter is not implement!")
