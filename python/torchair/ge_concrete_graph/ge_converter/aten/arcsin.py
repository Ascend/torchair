...
def conveter_aten_arcsin_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::arcsin(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arcsin.default ge converter is not implement!")
...
def conveter_aten_arcsin_out(
    ...
    raise NotImplementedError("torch.ops.aten.arcsin.out ge converter is not implement!")
