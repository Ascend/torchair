...
def conveter_aten_mul_Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_complex(a: complex, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_int_complex(a: int, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_complex_int(a: complex, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_float_complex(a: float, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_complex_float(a: complex, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_mul_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
