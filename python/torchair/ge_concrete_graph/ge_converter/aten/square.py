...
def conveter_aten_square_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::square(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.square.default ge converter is not implement!")
...
def conveter_aten_square_out(
    ...
    raise NotImplementedError("torch.ops.aten.square.out ge converter is not implement!")
