...
def conveter_aten_tanh_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::tanh(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.tanh.default ge_converter is not implemented!")
...
def conveter_aten_tanh_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_tanh_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_tanh_complex(a: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_tanh_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
