...
def conveter_aten_special_bessel_j1_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::special_bessel_j1(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_bessel_j1.default ge converter is not implement!")
...
def conveter_aten_special_bessel_j1_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_bessel_j1.out ge converter is not implement!")
