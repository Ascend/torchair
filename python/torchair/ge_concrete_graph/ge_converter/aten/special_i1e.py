...
def conveter_aten_special_i1e_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::special_i1e(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_i1e.default ge converter is not implement!")
...
def conveter_aten_special_i1e_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_i1e.out ge converter is not implement!")
