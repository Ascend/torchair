...
def conveter_aten_pow_Tensor_Tensor(
    self: Tensor, exponent: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_pow_Tensor_Scalar(
    self: Tensor, exponent: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_pow_Scalar(
    self: Union[Number, Tensor], exponent: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_pow_Tensor_Tensor_out(
    self: Tensor, exponent: Tensor, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_pow_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_complex(a: complex, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_float_complex(a: float, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_complex_float(a: complex, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_pow_int_to_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
