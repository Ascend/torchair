...
def conveter_aten_logical_or_default(
    ...
    raise NotImplementedError("torch.ops.aten.logical_or.default ge converter is not implement!")
...
def conveter_aten_logical_or_out(
    ...
    raise NotImplementedError("torch.ops.aten.logical_or.out ge converter is not implement!")
