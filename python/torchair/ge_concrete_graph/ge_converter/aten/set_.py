...
def conveter_aten_set__source_Tensor(
    self: Tensor, source: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_set__default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
