...
def conveter_aten_mkldnn_rnn_layer_default(
    ...
    raise NotImplementedError("torch.ops.aten.mkldnn_rnn_layer.default ge converter is not implement!")
...
def conveter_aten_mkldnn_rnn_layer_out(
    ...
    raise NotImplementedError("torch.ops.aten.mkldnn_rnn_layer.out ge converter is not implement!")
