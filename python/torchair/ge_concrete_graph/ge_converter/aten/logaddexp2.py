...
def conveter_aten_logaddexp2_default(
    ...
    raise NotImplementedError("torch.ops.aten.logaddexp2.default ge converter is not implement!")
...
def conveter_aten_logaddexp2_out(
    ...
    raise NotImplementedError("torch.ops.aten.logaddexp2.out ge converter is not implement!")
