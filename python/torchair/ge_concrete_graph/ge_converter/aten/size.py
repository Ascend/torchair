...
def conveter_aten_size_int(self: Tensor, dim: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_size_Dimname(self: Tensor, dim: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_size_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
