...
def conveter_aten_native_layer_norm_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten.native_layer_norm_backward.default ge_converter is not implemented!")
...
def conveter_aten_native_layer_norm_backward_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.native_layer_norm_backward.out ge_converter is not implemented!")
