...
def conveter_aten_rnn_tanh_input(
    ...
    raise NotImplementedError("torch.ops.aten.rnn_tanh.input ge converter is not implement!")
...
def conveter_aten_rnn_tanh_data(
    ...
    raise NotImplementedError("torch.ops.aten.rnn_tanh.data ge converter is not implement!")
