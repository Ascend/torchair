...
def conveter_aten_randn_like_default(
    ...
    raise NotImplementedError("torch.ops.aten.randn_like.default ge converter is not implement!")
...
def conveter_aten_randn_like_out(
    ...
    raise NotImplementedError("torch.ops.aten.randn_like.out ge converter is not implement!")
