...
def conveter_aten_heaviside_default(
    self: Tensor, values: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_heaviside_out(
    self: Tensor, values: Tensor, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
