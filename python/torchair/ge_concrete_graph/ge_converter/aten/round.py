...
def conveter_aten_round_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_round_decimals(
    self: Tensor, *, decimals: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_round_decimals_out(
    self: Tensor, *, decimals: int, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_round_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_round_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_round_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
