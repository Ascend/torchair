...
def conveter_aten_special_i0_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::special_i0(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_i0.default ge converter is not implement!")
...
def conveter_aten_special_i0_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_i0.out ge converter is not implement!")
