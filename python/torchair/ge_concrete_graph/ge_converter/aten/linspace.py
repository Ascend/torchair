...
def conveter_aten_linspace_default(
    ...
    raise NotImplementedError("torch.ops.aten.linspace.default ge converter is not implement!")
...
def conveter_aten_linspace_out(
    ...
    raise NotImplementedError("torch.ops.aten.linspace.out ge converter is not implement!")
