...
def conveter_aten_special_entr_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::special_entr(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.special_entr.default ge converter is not implement!")
...
def conveter_aten_special_entr_out(
    ...
    raise NotImplementedError("torch.ops.aten.special_entr.out ge converter is not implement!")
