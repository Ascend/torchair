...
def conveter_aten_acosh_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_acosh_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_acosh_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_acosh_complex(a: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_acosh_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
