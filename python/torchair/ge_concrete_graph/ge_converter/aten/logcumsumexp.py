...
def conveter_aten_logcumsumexp_default(
    self: Tensor, dim: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_logcumsumexp_dimname(
    self: Tensor, dim: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_logcumsumexp_dimname_out(
    self: Tensor, dim: str, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_logcumsumexp_out(
    self: Tensor, dim: int, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
