...
def conveter_aten_logical_not_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::logical_not(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.logical_not.default ge converter is not implement!")
...
def conveter_aten_logical_not_out(
    ...
    raise NotImplementedError("torch.ops.aten.logical_not.out ge converter is not implement!")
