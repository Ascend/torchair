...
def conveter_aten_isneginf_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::isneginf(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.isneginf.default ge converter is not implement!")
...
def conveter_aten_isneginf_out(
    ...
    raise NotImplementedError("torch.ops.aten.isneginf.out ge converter is not implement!")
