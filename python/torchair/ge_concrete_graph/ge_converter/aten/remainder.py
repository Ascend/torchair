...
def conveter_aten_remainder_Scalar_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.remainder.Scalar_Tensor ge_converter is not implemented!")
...
def conveter_aten_remainder_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.remainder.Tensor_out ge_converter is not implemented!")
...
def conveter_aten_remainder_Scalar_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.remainder.Scalar_out ge_converter is not implemented!")
...
def conveter_aten_remainder_Scalar_Tensor_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.remainder.Scalar_Tensor_out ge_converter is not implemented!")


@register_fx_node_ge_converter(torch.ops.aten.remainder.int)
def conveter_aten_remainder_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::remainder.int(int a, int b) -> int"""
    raise NotImplementedError("torch.ops.aten.remainder.int ge_converter is not implemented!")


@register_fx_node_ge_converter(torch.ops.aten.remainder.float)
def conveter_aten_remainder_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::remainder.float(float a, float b) -> float"""
    raise NotImplementedError("torch.ops.aten.remainder.float ge_converter is not implemented!")


@register_fx_node_ge_converter(torch.ops.aten.remainder.int_float)
def conveter_aten_remainder_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::remainder.int_float(int a, float b) -> float"""
    raise NotImplementedError("torch.ops.aten.remainder.int_float ge_converter is not implemented!")


@register_fx_node_ge_converter(torch.ops.aten.remainder.float_int)
def conveter_aten_remainder_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::remainder.float_int(float a, int b) -> float"""
    raise NotImplementedError("torch.ops.aten.remainder.float_int ge_converter is not implemented!")
...
def conveter_aten_remainder_default(
    ...
    raise NotImplementedError("torch.ops.aten.remainder.default ge_converter is not implemented!")
