...
def conveter_aten_mv_default(
        self: Tensor,
        vec: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::mv(Tensor self, Tensor vec) -> Tensor """
    raise NotImplementedError("torch.ops.aten.mv.default ge converter is not implement!")
...
def conveter_aten_mv_out(
    ...
    raise NotImplementedError("torch.ops.aten.mv.out ge converter is not implement!")
