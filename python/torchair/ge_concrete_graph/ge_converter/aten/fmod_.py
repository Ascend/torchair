...
def conveter_aten_fmod__Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::fmod_.Tensor(Tensor(a!) self, Tensor other) -> Tensor(a!)"""
    raise NotImplementedError("torch.ops.aten.fmod_.Tensor ge_converter is not implemented!")
...
def conveter_aten_fmod__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.fmod_.Scalar ge_converter is not implemented!")
