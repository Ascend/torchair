...
def conveter_aten_absolute_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::absolute(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.absolute.default ge converter is not implement!")
...
def conveter_aten_absolute_out(
    ...
    raise NotImplementedError("torch.ops.aten.absolute.out ge converter is not implement!")
