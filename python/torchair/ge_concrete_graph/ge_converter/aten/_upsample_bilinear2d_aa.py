...
def conveter_aten__upsample_bilinear2d_aa_default(
    ...
    raise NotImplementedError("torch.ops.aten._upsample_bilinear2d_aa.default ge converter is not implement!")
...
def conveter_aten__upsample_bilinear2d_aa_out(
    ...
    raise NotImplementedError("torch.ops.aten._upsample_bilinear2d_aa.out ge converter is not implement!")
...
def conveter_aten__upsample_bilinear2d_aa_vec(
    ...
    raise NotImplementedError("torch.ops.aten._upsample_bilinear2d_aa.vec ge converter is not implement!")
