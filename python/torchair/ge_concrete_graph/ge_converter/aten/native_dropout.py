...
def conveter_aten_native_dropout_default(
    ...
    raise NotImplementedError("torch.ops.aten.native_dropout.default ge converter is not implement!")
...
def conveter_aten_native_dropout_out(
    ...
    raise NotImplementedError("torch.ops.aten.native_dropout.out ge converter is not implement!")
