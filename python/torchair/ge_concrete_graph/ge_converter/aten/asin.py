...
def conveter_aten_asin_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_asin_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_asin_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_asin_complex(a: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_asin_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
