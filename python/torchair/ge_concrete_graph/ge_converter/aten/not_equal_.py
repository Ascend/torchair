...
def conveter_aten_not_equal__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal_.Scalar ge converter is not implement!")
...
def conveter_aten_not_equal__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.not_equal_.Tensor ge converter is not implement!")
