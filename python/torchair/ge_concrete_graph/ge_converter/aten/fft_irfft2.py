...
def conveter_aten_fft_irfft2_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_irfft2.default ge converter is not implement!")
...
def conveter_aten_fft_irfft2_out(
    ...
    raise NotImplementedError("torch.ops.aten.fft_irfft2.out ge converter is not implement!")
