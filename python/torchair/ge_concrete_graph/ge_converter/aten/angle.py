...
def conveter_aten_angle_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_angle_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_angle_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_angle_complex(a: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_angle_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
