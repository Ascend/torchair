...
def conveter_aten_copy__default(
    self: Tensor, src: Tensor, non_blocking: bool = False, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
...
def conveter_aten_copy__Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_copy__int(self: Tensor, other: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_copy__float(self: Tensor, other: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
