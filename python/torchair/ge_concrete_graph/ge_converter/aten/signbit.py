...
def conveter_aten_signbit_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::signbit(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.signbit.default ge converter is not implement!")
...
def conveter_aten_signbit_out(
    ...
    raise NotImplementedError("torch.ops.aten.signbit.out ge converter is not implement!")
