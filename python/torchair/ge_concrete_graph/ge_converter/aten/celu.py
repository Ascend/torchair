...
def conveter_aten_celu_default(
    ...
    raise NotImplementedError("torch.ops.aten.celu.default ge converter is not implement!")
...
def conveter_aten_celu_out(
    ...
    raise NotImplementedError("torch.ops.aten.celu.out ge converter is not implement!")
