...
def conveter_aten_ones_like_default(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.ones_like.default ge_converter is not implemented!")
...
def conveter_aten_ones_like_out(
    ...
    *,
    ...
    raise NotImplementedError("torch.ops.aten.ones_like.out ge_converter is not implemented!")
