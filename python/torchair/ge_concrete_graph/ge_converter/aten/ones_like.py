...
def conveter_aten_ones_like_default(
    ...
    raise NotImplementedError("torch.ops.aten.ones_like.default ge converter is not implement!")
...
def conveter_aten_ones_like_out(
    ...
    raise NotImplementedError("torch.ops.aten.ones_like.out ge converter is not implement!")
