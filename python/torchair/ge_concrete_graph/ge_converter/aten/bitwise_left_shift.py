...
def conveter_aten_bitwise_left_shift_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift_Tensor_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Tensor_Scalar ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift_Scalar_Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Scalar_Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Tensor_out ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift_Tensor_Scalar_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Tensor_Scalar_out ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift_Scalar_Tensor_out(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift.Scalar_Tensor_out ge converter is not implement!")
