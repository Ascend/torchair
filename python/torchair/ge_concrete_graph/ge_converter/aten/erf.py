...
def conveter_aten_erf_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::erf(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.erf.default ge_converter is not implemented!")
...
def conveter_aten_erf_int(a: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_erf_float(a: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_erf_Scalar(a: Union[Number, Tensor], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
