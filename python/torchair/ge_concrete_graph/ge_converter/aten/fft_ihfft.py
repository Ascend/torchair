...
def conveter_aten_fft_ihfft_default(
    ...
    raise NotImplementedError("torch.ops.aten.fft_ihfft.default ge converter is not implement!")
...
def conveter_aten_fft_ihfft_out(
    ...
    raise NotImplementedError("torch.ops.aten.fft_ihfft.out ge converter is not implement!")
