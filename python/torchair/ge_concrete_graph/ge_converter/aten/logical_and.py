...
def conveter_aten_logical_and_default(
    ...
    raise NotImplementedError("torch.ops.aten.logical_and.default ge converter is not implement!")
...
def conveter_aten_logical_and_out(
    ...
    raise NotImplementedError("torch.ops.aten.logical_and.out ge converter is not implement!")
