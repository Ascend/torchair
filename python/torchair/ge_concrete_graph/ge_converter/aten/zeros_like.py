...
def conveter_aten_zeros_like_default(
    ...
    raise NotImplementedError("torch.ops.aten.zeros_like.default ge converter is not implement!")
...
def conveter_aten_zeros_like_out(
    ...
    raise NotImplementedError("torch.ops.aten.zeros_like.out ge converter is not implement!")
