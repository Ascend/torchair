...
def conveter_aten_dot_default(self: Tensor, tensor: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_dot_out(
    self: Tensor, tensor: Tensor, *, out: Tensor = None, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
