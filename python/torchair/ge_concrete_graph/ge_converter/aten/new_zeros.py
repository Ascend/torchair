...
def conveter_aten_new_zeros_default(
    ...
    raise NotImplementedError("torch.ops.aten.new_zeros.default ge converter is not implement!")
...
def conveter_aten_new_zeros_out(
    ...
    raise NotImplementedError("torch.ops.aten.new_zeros.out ge converter is not implement!")
