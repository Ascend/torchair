...
def conveter_aten__adaptive_avg_pool2d_backward_default(
    ...
    raise NotImplementedError("torch.ops.aten._adaptive_avg_pool2d_backward.default ge converter is not implement!")
...
def conveter_aten__adaptive_avg_pool2d_backward_out(
    ...
    raise NotImplementedError("torch.ops.aten._adaptive_avg_pool2d_backward.out ge converter is not implement!")
