...
def conveter_aten_upsample_bicubic2d_vec(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_bicubic2d.vec ge converter is not implement!")
...
def conveter_aten_upsample_bicubic2d_default(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_bicubic2d.default ge converter is not implement!")
...
def conveter_aten_upsample_bicubic2d_out(
    ...
    raise NotImplementedError("torch.ops.aten.upsample_bicubic2d.out ge converter is not implement!")
