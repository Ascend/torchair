...
def conveter_aten_ge_Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ge_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ge_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ge_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ge_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ge_str(a: str, b: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
