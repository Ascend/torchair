...
def conveter_aten_arctanh_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::arctanh(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arctanh.default ge converter is not implement!")
...
def conveter_aten_arctanh_out(
    ...
    raise NotImplementedError("torch.ops.aten.arctanh.out ge converter is not implement!")
