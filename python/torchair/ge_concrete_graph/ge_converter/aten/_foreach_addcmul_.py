...
def conveter_aten__foreach_addcmul__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_addcmul_.Scalar ge converter is not implement!")
...
def conveter_aten__foreach_addcmul__ScalarList(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_addcmul_.ScalarList ge converter is not implement!")
...
def conveter_aten__foreach_addcmul__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten._foreach_addcmul_.Tensor ge converter is not implement!")
