...
def conveter_aten_negative_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::negative(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.negative.default ge converter is not implement!")
...
def conveter_aten_negative_out(
    ...
    raise NotImplementedError("torch.ops.aten.negative.out ge converter is not implement!")
