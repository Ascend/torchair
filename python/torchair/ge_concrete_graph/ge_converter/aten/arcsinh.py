...
def conveter_aten_arcsinh_default(
        self: Tensor,
        meta_outputs: Any = None):
    """ NB: aten::arcsinh(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arcsinh.default ge converter is not implement!")
...
def conveter_aten_arcsinh_out(
    ...
    raise NotImplementedError("torch.ops.aten.arcsinh.out ge converter is not implement!")
