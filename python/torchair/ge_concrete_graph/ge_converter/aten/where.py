...
def conveter_aten_where_self(
    condition: Tensor, self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None
):
    """NB: aten::where.self(Tensor condition, Tensor self, Tensor other) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.where.self ge_converter is not implemented!")
...
def conveter_aten_where_default(condition: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
