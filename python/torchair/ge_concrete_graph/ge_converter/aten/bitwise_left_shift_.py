...
def conveter_aten_bitwise_left_shift__Tensor_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift_.Tensor_Scalar ge converter is not implement!")
...
def conveter_aten_bitwise_left_shift__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_left_shift_.Tensor ge converter is not implement!")
