...
def conveter_aten_trunc_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::trunc(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.trunc.default ge converter is not implement!")
...
def conveter_aten_trunc_out(
    ...
    raise NotImplementedError("torch.ops.aten.trunc.out ge converter is not implement!")
