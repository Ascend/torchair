...
def conveter_aten_bitwise_and__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_and_.Tensor ge converter is not implement!")
...
def conveter_aten_bitwise_and__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.bitwise_and_.Scalar ge converter is not implement!")
