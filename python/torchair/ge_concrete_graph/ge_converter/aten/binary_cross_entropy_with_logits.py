...
def conveter_aten_binary_cross_entropy_with_logits_default(
    ...
    raise NotImplementedError("torch.ops.aten.binary_cross_entropy_with_logits.default ge converter is not implement!")
...
def conveter_aten_binary_cross_entropy_with_logits_out(
    ...
    raise NotImplementedError("torch.ops.aten.binary_cross_entropy_with_logits.out ge converter is not implement!")
