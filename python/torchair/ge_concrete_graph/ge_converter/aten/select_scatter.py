...
def conveter_aten_select_scatter_default(
    ...
    raise NotImplementedError("torch.ops.aten.select_scatter.default ge converter is not implement!")
...
def conveter_aten_select_scatter_out(
    ...
    raise NotImplementedError("torch.ops.aten.select_scatter.out ge converter is not implement!")
