...
def conveter_aten_arctan_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::arctan(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.arctan.default ge converter is not implement!")
...
def conveter_aten_arctan_out(
    ...
    raise NotImplementedError("torch.ops.aten.arctan.out ge converter is not implement!")
