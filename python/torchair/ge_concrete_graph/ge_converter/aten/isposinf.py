...
def conveter_aten_isposinf_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::isposinf(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.isposinf.default ge converter is not implement!")
...
def conveter_aten_isposinf_out(
    ...
    raise NotImplementedError("torch.ops.aten.isposinf.out ge converter is not implement!")
