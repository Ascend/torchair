...
def conveter_aten_copysign__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.copysign_.Tensor ge converter is not implement!")
...
def conveter_aten_copysign__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.copysign_.Scalar ge converter is not implement!")
