...
def conveter_aten_igammac_default(
    ...
    raise NotImplementedError("torch.ops.aten.igammac.default ge converter is not implement!")
...
def conveter_aten_igammac_out(
    ...
    raise NotImplementedError("torch.ops.aten.igammac.out ge converter is not implement!")
