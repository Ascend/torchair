...
def conveter_aten_digamma_default(
        self: Tensor,
        meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """ NB: aten::digamma(Tensor self) -> Tensor """
    raise NotImplementedError("torch.ops.aten.digamma.default ge converter is not implement!")
...
def conveter_aten_digamma_out(
    ...
    raise NotImplementedError("torch.ops.aten.digamma.out ge converter is not implement!")
