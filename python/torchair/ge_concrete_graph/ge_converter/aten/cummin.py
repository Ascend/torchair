...
def conveter_aten_cummin_default(self: Tensor, dim: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_cummin_dimname(self: Tensor, dim: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
