...
def conveter_aten_relu_default(self: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::relu(Tensor self) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.relu.default ge_converter is not implemented!")
