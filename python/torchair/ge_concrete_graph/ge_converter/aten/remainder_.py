...
def conveter_aten_remainder__Tensor(
    ...
    raise NotImplementedError("torch.ops.aten.remainder_.Tensor ge converter is not implement!")
...
def conveter_aten_remainder__Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.remainder_.Scalar ge converter is not implement!")
