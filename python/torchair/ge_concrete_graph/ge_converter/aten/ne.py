...
def conveter_aten_ne_Tensor(self: Tensor, other: Tensor, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
    """NB: aten::ne.Tensor(Tensor self, Tensor other) -> Tensor"""
    raise NotImplementedError("torch.ops.aten.ne.Tensor ge_converter is not implemented!")
...
def conveter_aten_ne_Scalar(
    ...
    raise NotImplementedError("torch.ops.aten.ne.Scalar ge_converter is not implemented!")
...
def conveter_aten_ne_int_list(a: List[int], b: List[int], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_device(a: Device, b: Device, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_bool(a: bool, b: bool, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_int(a: int, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_complex(a: complex, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_float(a: float, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_int_float(a: int, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_float_int(a: float, b: int, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_float_complex(a: float, b: complex, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_complex_float(a: complex, b: float, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_str(a: str, b: str, meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_bool_list(a: List[bool], b: List[bool], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
...
def conveter_aten_ne_str_list(a: List[str], b: List[str], meta_outputs: Union[TensorSpec, List[TensorSpec]] = None):
