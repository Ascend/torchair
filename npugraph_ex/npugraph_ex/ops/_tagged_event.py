...
from npugraph_ex.scope._scope_attr import _npu_get_or_create_stream_with_tag
...
# 2.5及以下版本dynamo原生不支持built-in里面的call_id操作，导致fullgraph成图时触发unsupported报错。
# 仅在2.6及以上版本使用id实现双向字典提升event查找效率。
