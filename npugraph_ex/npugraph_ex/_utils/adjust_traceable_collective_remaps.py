...
def adjust_traceable_collective_remaps():
    if torch.__version__ >= '2.3.1':
        from npugraph_ex.ops._hcom_alltoall import npu_all_to_all_patch_dist
        from npugraph_ex.ops._hcom_broadcast import npu_broadcast_patch_dist
        from npugraph_ex.ops._hcom_send_recv import npu_send_patch_dist, npu_recv_patch_dist
        ...
        try:
            ...
            from npugraph_ex.ops._hcom_allgather import npu_allgather_into_tensor_uneven_patch_dist
            from npugraph_ex.ops._hcom_reducescatter import npu_reduce_scatter_tensor_uneven_patch_dist
