...
_ALLOWED_CLASSES = {
    "npugraph_ex.inference._cache_compiler.ModelCacheMeta",
    "npugraph_ex.inference._cache_compiler.CompiledFX",
    "npugraph_ex.inference._cache_compiler.ModelCacheArtifact"
}
...
class CacheBackend:
    def __init__(self, config: Optional[CompilerConfig], saver: 'ModelCacheSaver', *,
        ...
        if fw_compiler is None:
            from npugraph_ex.npu_fx_compiler import get_compiler
