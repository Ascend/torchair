...
| GE dump图 | 参考[《CANN 环境变量参考》](https://hiascend.com/document/redirect/CannCommunityEnvRef)中的“DUMP_GE_GRAPH”章节，设置环境变量DUMP_GE_GRAPH，查看GE的dump图信息。 |
| CANN侧plog日志 | - 参考[《CANN 环境变量参考》](https://hiascend.com/document/redirect/CannCommunityEnvRef)中的“ASCEND_GLOBAL_LOG_LEVEL”章节，设置环境变量export ASCEND_GLOBAL_LOG_LEVEL=0开启plog debug日志。<br>- 参考[《CANN 环境变量参考》](https://hiascend.com/document/redirect/CannCommunityEnvRef)中的“ASCEND_SLOG_PRINT_TO_STDOUT”章节，设置环境变量export ASCEND_SLOG_PRINT_TO_STDOUT=1开启日志打印。 |
