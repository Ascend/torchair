...
本章**仅提供基于Ascend C工程化开发算子的关键步骤说明**，详细的操作请参考《[CANN Ascend C算子开发](https://hiascend.com/document/redirect/CannCommunityOpdevAscendC)》中的“算子实现\>工程化算子开发”章节，例如算子原型json文件的参数含义、msOpGen工具的命令说明等。
