...
#define ATEN2GE_MAP_TYPE(T1, T2) \
  ...
  switch (dtype) {
    ...
    ATEN2GE_MAP_TYPE(c10::ScalarType::Float8_e5m2, ge::DataType::DT_FLOAT8_E5M2);
    ATEN2GE_MAP_TYPE(c10::ScalarType::Float8_e4m3fn, ge::DataType::DT_FLOAT8_E4M3FN);
#if defined(TNG_TORCH_VERSION) && (TNG_TORCH_VERSION > 20700) // 2.7.
    ATEN2GE_MAP_TYPE(c10::ScalarType::Float8_e8m0fnu, ge::DataType::DT_FLOAT8_E8M0);
#endif
    default:
...
#define GE2ATEN_MAP_TYPE_BY_NUM(T1, NUM)                            \
  ...
  switch (ge_dtype) {
    ...
    GE2ATEN_MAP_TYPE(ge::DataType::DT_FLOAT8_E4M3FN, c10::ScalarType::Float8_e4m3fn);
    default:
