...
PYBIND11_MODULE(_npu_utils, m) {
  ...
  // Ensure both import paths resolve to the same native module instance.
  modules[py::str("torchair.core._npu_utils")] = m;
  modules[py::str("torch_npu.dynamo.torchair.core._npu_utils")] = m;
