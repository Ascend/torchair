...
TEST_F(E2E_LoadAbsStore, Codegen_Kernel)
{
  ...
  EXPECT_EQ(kernel_code, std::string{
    ...
    "const int z0z1TB = block_dim % ((t.s0 * t.s1) / (t.z1t_size * t.z0z1Tb_size)); block_dim /= (t.s0 * t.s1) / (t.z1t_size * t.z0z1Tb_size);\n"
    "\n"
    ...
    "\n"
    "\n"
    "for (int z0z1Tb = 0; z0z1Tb < t.z0z1Tb_size; z0z1Tb++) {\n"
    "{\n"
    "LocalTensor<uint8_t> q0_buf = q0.AllocTensor<uint8_t>();\n"
    "LocalTensor<half> load_y;\n"
    "load_y.SetAddrWithOffset(q0_buf, 0);\n"
    "DataCopy(load_y[0], x_y[z0z1TB * (t.s2 * t.z1t_size * t.z0z1Tb_size) + z0z1Tb * (t.s2 * t.z1t_size)], load_y_size);\n"
    "q0.EnQue(q0_buf);\n"
    "}\n"
    "{\n"
    ...
    "LocalTensor<half> abs_y;\n"
    "abs_y.SetAddrWithOffset(q1_buf, 0);\n"
    "DataCopy(store_y[z0z1TB * (t.s2 * t.z1t_size * t.z0z1Tb_size) + z0z1Tb * (t.s2 * t.z1t_size)], abs_y[0], abs_y_size);\n"
